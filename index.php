...
<body>
        ...
        <div class="home-div">
            ...
            <div class="home-text">
                <div class="whatsapp-message">
                    <span lass="whatsapp-text" style="color: white;">Olá! 😃 <span class="wave-emoji">👋</span></span>
                </div>
                
                <h3></h3>
                <span class="logo-container">
                    <img src="img/logo.png" class="logo-animated" alt="Logo ASC Digital">
                </span>
                <h3></h3>
                <h3>Uma <span>nova</span> experiência com Marketing<span> Digital</span></h3>
                <div class="button">
                    <a href="https://api.whatsapp.com/send/?phone=5519992490898" target="_blank" class="btn" style="color: white;">Entrar em Contato!</a>
                </div>
            </div>
        </div>
        <div class="more-button">
            <a href="#about" class="btn3"><span><i class="bx bx-chevron-down" style="color: white;"></i></span> Ver mais</a>
        </div>
    </section>
    ...
    <div class="main-text-about">
        ...
        <p>Conheça a equipe que vai elevar os resultados da sua empresa 🚀.</p>
    </div>
    <!--about section design-->
    <section class="about" id="about">

        <div class="about-img">
            <img src="https://avatars.githubusercontent.com/u/59294941?v=4">
        </div>
        <div class="about-text" style="display: flex; flex-direction: column;">
            <h2>Adriano <span>Carvalho</span></h2>
        ...
        <div class="about-img-r-mobile">
            <img src="./img/nathy.jpeg">
        </div>
        <div class="about-text-r">
            <h2>Nathaly <span>Nasario</span></h2>
            <h4>Social Media e Copywriter 📝</h4>
    ...
    <section class="portfolio" id="portfolio">
        <div class="main-text">
            ...
            <p>Veja o depoimento de alguns dos nossos clientes! 🤩</p>
        </div>
    ...
    <section class="services" id="contact">
        <div class="main-text">
            <h2><span>Entre</span> em contato!</h2>
            <p>Preencha o fomulário abaixo com os seus dados!</p>
            <p>Em breve nossa equipe vai te chamar 😉</p>
        </div>

        <div class="pipefy-web">
            <iframe 
                width="560"
                height="600"
                frameborder='0'
                src='https://app.pipefy.com/public/form/f12k8m1m?embedded=true'
            ></iframe>
        </div>

        <div class="pipefy-mobile">
            <iframe 
                width="400"
                height="600"
                frameborder='0'
    ...
    <section class="end">
        <div class="last-text">
            <p>ASC Digital &#169; 2024.</p>
            <p>CNPJ: 50.177.446/0001-64</p>
        </div>
    </section>

    <div id="top">
        <a href="#home"><i class="bx bx-up-arrow-alt " style="color: white;"></i></a>
    </div>
